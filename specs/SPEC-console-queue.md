...
Row-scoped retry is implemented, bound to `R` in the queue pane. Removal is
implemented, bound to `x` in the queue pane. Reordering, export, and queue
editing remain planned. All five are scoped as follows.
